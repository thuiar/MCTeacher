...
class V1_Semi(nn.Module):
    def __init__(self, args):
        ...
        # 
        self.thernet_1 = nn.Linear(self.post_fusion_dim*4,self.post_fusion_dim)
        self.thernet_2 = nn.Linear(self.post_fusion_dim,2)
        # 
        # self.thernet_map_1 = nn.Linear(4,self.post_fusion_dim)
        # self.thernet_map_2 = nn.Linear(self.post_fusion_dim,self.post_fusion_dim)
